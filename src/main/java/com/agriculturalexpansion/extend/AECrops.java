...
public class AECrops {
	...
	public static class ExperienceCrop extends AECrop {
		public ExperienceCrop(String name) {
			super(name);
		}
		public Item getSeed() {
	...
	public static class PlatinumCrop extends AECrop {
		public PlatinumCrop(String name) {
			super(name);
		}
		public Item getSeed() {
	...
	public static class AluminumCrop extends AECrop {
		public AluminumCrop(String name) {
			super(name);
		}
		public Item getSeed() {
	...
	public static class AlubrassCrop extends AECrop {
		public AlubrassCrop(String name) {
			super(name);
		}
		public Item getSeed() {
	...
	public static class ElectrumCrop extends AECrop {
		public ElectrumCrop(String name) {
			super(name);
		}
		public Item getSeed() {
	...
	public static class SapphireCrop extends AECrop {
		public SapphireCrop(String name) {
			super(name);
		}
		public Item getSeed() {
